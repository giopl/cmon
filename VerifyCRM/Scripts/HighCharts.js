/**
 * @license Highcharts JS v5.0.0 custom build (2016-10-25)
 *
    ...
    (function(H) {
        ...
        H.defaultOptions = {
            ...
            global: {
                ...
                VMLRadialGradientURL: 'http://code.highcharts.com@product.cdnpath@/5.0.0 custom build/gfx/vml-radial-gradient.png'
    ...
    (function(H) {
        ...
        SVGRenderer.prototype = {
            ...
            init: function(container, width, height, style, forExport, allowHTML) {
                ...
                desc.element.appendChild(doc.createTextNode('Created with Highcharts 5.0.0 custom build'));
